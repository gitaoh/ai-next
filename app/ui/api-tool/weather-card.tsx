...
export const WeatherCard: React.FC<WeatherCardProps> = ({ weatherData }) => {
  ...
  return (
    <div
      className={`relative h-24 w-full max-w-sm overflow-hidden rounded-xl border ${weatherStyle.borderColor} bg-black/40`}
    >
      ...
      <div className="relative flex h-full items-center justify-between px-6">
        ...
        <div className="text-right">
          <div className="mb-1 flex items-baseline justify-end">
            ...
            <span className="ml-1 text-lg text-gray-300">°C</span>
          </div>
